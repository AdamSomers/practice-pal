          ...
          >
            <div className="flex gap-2 pb-2">
              <input
                ...
                placeholder="Emoji"
                className="w-16 px-3 py-2 bg-gray-50 border border-gray-200 rounded-xl text-sm text-center focus:outline-none focus:ring-2 focus:ring-primary-400"
              />
              <input
                type="text"
                value={title}
              ...
              <button
                onClick={() => { setShowForm(false); setTitle(''); setEmoji(''); }}
